...
const SignupBTNcomponent = (i) => {
  return (
    <motion.a whileHover="hovered" href="#" className='relative flex justify-center items-center py-3 px-7'>
        <motion.span variants={{hovered: {color: "#AB6AFE"}}} className='font-["codePro"] uppercase text-[13px] font-semibold'>{i.text}</motion.span>
...
export default memo(SignupBTNcomponent)